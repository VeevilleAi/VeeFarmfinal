...
import com.veevillefarm.vfarm.adapter.AppDashBoardAdapter;
import com.veevillefarm.vfarm.farmer.FarmerProfileActivity;
...
public class DashBoardActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (title) {
            case "Logout":
                ...
                AppSingletonClass.logMessage(TAG, "user logged out");
                finish();
                break;
            case "Profile":
    ...
    private List<DashBoardClass> getDetails() {
        DashBoardClass chat = new DashBoardClass("Chat", "Chats", "", R.drawable.cerebro_iocn);
