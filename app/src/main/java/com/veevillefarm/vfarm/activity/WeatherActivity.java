...
import com.veevillefarm.vfarm.adapter.WeatherActivityAdapter;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void setUpWeatherRecyclerview() {
        ...
        AppSingletonClass.logMessage(TAG, "getting weather for the city:" + city);
        weatherApidata(city);
    ...
    private void weatherApidata(final String city) {
        String url = "http://api.worldweatheronline.com/premium/v1/weather.ashx?key=eac54c1d70de49b1af345957191401&q=" + city + "&format=json&num_of_days=10";
        AppSingletonClass.logMessage(TAG, "weather request uri:" + url);
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                AppSingletonClass.logMessage(TAG, "weather successfully retrieved:\n" + response.toString());
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.setVisibility(View.GONE);
                AppSingletonClass.logMessage(TAG, error.toString());
    ...
    //use this metho to ebugg message
    private void logMessage(String logMessage) {
        AppSingletonClass.logMessage(TAG, logMessage);
    }

    //this method to use debug error message
