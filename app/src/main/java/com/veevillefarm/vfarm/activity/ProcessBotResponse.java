...
import com.veevillefarm.vfarm.helper.ChatMessagesHelperFunctions;
import com.veevillefarm.vfarm.helper.ChatmessageDataClasses;
import com.veevillefarm.vfarm.helper.Countries;
import com.veevillefarm.vfarm.helper.DatabaseCredentials;
import com.veevillefarm.vfarm.helper.Fruit;
import com.veevillefarm.vfarm.helper.LanguageTransResult;
import com.veevillefarm.vfarm.helper.LanguageTranslater;
...
import static com.veevillefarm.vfarm.helper.AppSingletonClass.mFirebaseAuth;
import static com.veevillefarm.vfarm.helper.AppSingletonClass.verifixationIdMain;
...
public class ProcessBotResponse {
    ...
    //from here processing  of Bot response will start
    ...
    //request weather with date and city default city will be bangalore and default date will be Today
    private void weatherApidata(String date, final String city) {

        String url = "http://api.worldweatheronline.com/premium/v1/weather.ashx?key=eac54c1d70de49b1af345957191401&q=" + city + "&format=json&num_of_days=10&date=" + date;
    ...
    //insert user Mobile number to AWS database using AsyncTask worker class
    class MyAsyncTask extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer s) {
            ...
            if(s==0){
                logErrormeesage("insertion failed");
            }else {
                logMesage("mobile number inserted successfully");
            }
        }
    }
    ...
    //use this method to ebugg error messages
