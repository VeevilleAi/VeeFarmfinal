...
package com.veevillefarm.vfarm.env;
...
/**
 * Wrapper for the platform log function, allows convenient message prefixing and isabling.
 */
public final class Logger {
  private static final String DEFAULT_TAG = "tensorflow";
  private static final int DEFAULT_MIN_LOG_LEVEL = 10;
